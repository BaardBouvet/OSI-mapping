...
| [EXAMPLE-COVERAGE-PLAN.md](EXAMPLE-COVERAGE-PLAN.md) | Planned | Five new examples covering remaining uncovered schema properties: `array_path`, `links`/`link_key`, `elements: last_modified`, `scalar`, `soft_delete` on child, `order_prev`/`order_next`. |
